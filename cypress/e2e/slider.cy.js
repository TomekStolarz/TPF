...
describe('Swiper Gallery Test', function () {
  it('Checks slides have correct valeues', function () {
    cy.visit('http://localhost:3000');
...
describe('Swiper Gallery Test', () => {
  it('Should display gallery correctly on different devices and buttons are clicable', () => {
...
describe('Swiper Gallery Test', () => {
  it('Should display gallery correctly', () => {
    ...
    cy.get('.swiper-button-next').should('be.visible').should('not.be.disabled').click();
    cy.get('.swiper-button-prev').should('be.visible').should('not.be.disabled').click();
  });
});